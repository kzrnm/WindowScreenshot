...
{
    public static void OnUnhandledException_Debug(object sender, UnhandledExceptionEventArgs e)
    {
        if (e.ExceptionObject is not Exception exception) return;
        Debug.WriteLine($"Unhandled: {exception}");
    }

    public static void OnUnhandledException_Release(object sender, UnhandledExceptionEventArgs e)
    {
        if (e.ExceptionObject is not Exception exception) return;
